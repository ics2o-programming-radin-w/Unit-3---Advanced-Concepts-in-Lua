...
local bkg_image
local playButton
local Instructions Button
local Instructions Screen
-----------------------------------------------------------------------------------------
-- LOCAL FUNCTIONS
-----------------------------------------------------------------------------------------
...
local function CreditsTransition( )       
    composer.gotoScene( "Instructions Button", {effect = "flipFadeOutIn", time = 500})
end 
...
function scene:create( event )
    ...
    playButton = widget.newButton( 
        {   
            ...
            onRelease = Instructions Screen Transition       
        } )

    -----------------------------------------------------------------------------------------

    -- Creating Credits Button
    Instructions Button = widget.newButton( 
        {
            -- Set its position on the screen relative to the screen size
            ...
            onRelease = Instructions Transition
        } ) 
    ...
    sceneGroup:insert( Instuctions Button )
